	...
	public void onRender()
	{
		...
		if(is != null)
		{
			...
			if(drawPrediction)
			{
				...
				float var28 =
					MathHelper.sqrt_double(nextSegX * nextSegX + nextSegY
						* nextSegY + nextSegZ * nextSegZ);
				nextSegX /= var28;
				nextSegY /= var28;
				nextSegZ /= var28;
				nextSegX *= var5;
				...
				while(continueDraw)
				{
					...
					MovingObjectPosition movingObj =
						Minecraft.getMinecraft().theWorld.rayTraceBlocks(
							vecOrig, vecNew, false, true, false);
					if(movingObj != null)
					{
					...
					{
						drawLine3D(origX - playerX, origY - playerY, origZ
							- playerZ, newX - playerX, newY - playerY, newZ
							- playerZ);
						...
						for(int var36 = 0; var36 < 5; var36++)
						{
							...
							AxisAlignedBB var39 =
								AxisAlignedBB.fromBounds(bounding.minX, var37,
									bounding.minZ, bounding.maxX, var38,
									bounding.maxZ);
